...
<body>
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              ...
                              <a href="proses-hapus.php?idp=<?php echo $row['image_id'] ?>" class="btn">Hapus</a>
                           </td>
                        </tr>
                        <?php }}else{ ?>
                             <tr>
   ...
   <?php if(@$_SESSION['ex']){ ?>
    ...
    <?php if(@$_SESSION['h']){ ?>
    <script>
        swal({title: "Warning!",text: "<?php echo $_SESSION['h']; ?>",icon: "warning",buttons: ["No","Yes"],dangerMode: true,}).then((value)=>{if(value){
          <?php
          if(isset($_GET['idp'])){
   ...
   ?>
            window.location.replace('data-image.php');
        }});</script>
