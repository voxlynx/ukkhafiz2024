...
<!--Like-->
    <div class="col-2">
        ...
        $gam=$_POST['gam'];
        $adname=$_SESSION['a_global']->admin_name;
        $like=$_POST['like'];
...
if(isset($_POST['submit'])){
    if($_SESSION['status_login'] != true){
        ...
        $image=$_POST['image'];
        $adminid=$_SESSION['a_global']->admin_id;
        $adminnm=$_SESSION['a_global']->admin_name;
...
if (isset($_GET['komentar'])) {
    $kid = $_GET['komentarID'];
    $FotoID = $_GET['Fotoid'];
    $aid=$_SESSION['a_global']->admin_id;
    $sql = mysqli_query($koneksi, "DELETE FROM komentarfoto WHERE komentarID='$kid' AND admin_id='$aid'");
